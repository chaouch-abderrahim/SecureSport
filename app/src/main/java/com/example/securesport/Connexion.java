...
public class Connexion extends AppCompatActivity {
        ...
        loginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkCredentials() || checkFingerprint()) {
                    ...
                    Toast.makeText(Connexion.this, "Nom d'utilisateur, mot de passe ou empreinte digitale incorrect", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
            ...
            FingerprintManagerCompat.AuthenticationCallback authenticationCallback =
                    new FingerprintManagerCompat.AuthenticationCallback() {
                        ...
                        public void onAuthenticationSucceeded(FingerprintManagerCompat.AuthenticationResult result) {
                            ...
                            Toast.makeText(Connexion.this, "Authentification réussie par empreinte digitale", Toast.LENGTH_SHORT).show();
                            redirectToHomePage();
                        }
                        ...
                        public void onAuthenticationHelp(int helpCode, CharSequence helpString) {
                            ...
                            Toast.makeText(Connexion.this, "Aide pendant l'authentification: " + helpString, Toast.LENGTH_SHORT).show();
                        }
                        ...
                        public void onAuthenticationFailed() {
                            ...
                            Toast.makeText(Connexion.this, "Échec de l'authentification par empreinte digitale", Toast.LENGTH_SHORT).show();
                        }
                        ...
                        public void onAuthenticationError(int errorCode, CharSequence errString) {
                            ...
                            Toast.makeText(Connexion.this, "Erreur pendant l'authentification: " + errString, Toast.LENGTH_SHORT).show();
                        }
                    };
    ...
    private void redirectToHomePage() {
        Intent intent = new Intent(Connexion.this, HomeFragment.class);
        startActivity(intent);
    }
}